<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('grades.retakes')" :active="request()->routeIs('grades.retakes')">
                        {{ __('Retake') }}
                    </x-nav-link>
                    <x-nav-link :href="route('grades.downloadPDF')">
                        {{ __('Download PDF') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500
                               hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition">
    ...
    <!-- Responsive Navigation Menu & Settings -->
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('grades.retakes')" :active="request()->routeIs('grades.retakes')">
                {{ __('Retake') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('grades.downloadPDF')">
                {{ __('Download PDF') }}
            </x-responsive-nav-link>
        </div>
